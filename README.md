...
`dashboard/` 디렉토리에 **Command Center** 스타일의 웹 대시보드가 포함되어 있습니다.

- **기술 스택:** React 19 + TypeScript + Tailwind CSS 4 + shadcn/ui
- **디자인:** 군사 정보 커맨드 센터 스타일 (다크 네이비 테마)
- **기능:** 3컬럼 비대칭 레이아웃, 실시간 뉴스 틱커, 카테고리 필터, 시장 센티먼트 게이지, AI 분석 패널
- **상세 정보:** [`dashboard/README.md`](dashboard/README.md) 참조
